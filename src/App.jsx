                            ...
                            >
                              ...
                              {p.contact_info && (
                                <button
                                  ...
                                  className="absolute bottom-1 right-1.5 text-slate-400 hover:text-[#5865F2] transition-colors cursor-copy scale-110 active:scale-95 z-10 p-0.5 rounded-sm hover:bg-slate-100"
                                >
